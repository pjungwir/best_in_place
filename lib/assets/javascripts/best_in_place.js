...
BestInPlaceEditor.prototype = {
  ...
  update : function() {
    ...
    if (this.formType == "select") {
      ...
      jQuery.each(this.values, function(i, v) {
        if (value.indexOf(v[0]) > -1) {
          editor.element.html(v[1]);
        }
      });

    } else if (this.formType == "multiselect") {
      var value = this.getValue();
      this.previousCollectionValue = value;
    ...
    } else if (this.formType == "checkboxes") {
      var value = this.getValue();
      this.previousCollectionValue = value;
      // Don't reset the editor for checkboxes,
  ...
  initOptions : function() {
    ...
    if ((self.formType == "select" || self.formType == "multiselect" || self.formType == 'checkboxes' || self.formType == "checkbox") && self.collection !== null)
    {
  ...
  requestData : function() {
    ...
    if (return_data instanceof Array) {
      ...
      if (return_data.length > 0) {
        ...
        if (this.formType === 'checkboxes') {
          return_data.push(this.objectName + '[' + this.attributeName + '][]=');
        }
      }
  ...
  loadSuccessCallback : function(data) {
    ...
    if (this.collectionValue !== null && (this.formType == "select" || this.formType == "multiselect" || this.formType == 'checkboxes')) {
...
BestInPlaceEditor.forms = {
  ...
  "checkboxes" : {
    activateForm : function() {
      ...
      jQuery.each(this.values, function (index, value) {
        var $label = jQuery(document.createElement("label"))
                      ...
                      .attr('class', form.inner_class !== null ? form.inner_class : '' );
      ...
      this.element.html(output);
      this.setHtmlAttributes();
      this.element.find("input").bind('change', {editor: this}, BestInPlaceEditor.forms.checkboxes.changeHandler);
      // this.element.find("select").bind('blur', {editor: this}, BestInPlaceEditor.forms.select.blurHandler);
      // this.element.find("select").bind('keyup', {editor: this}, BestInPlaceEditor.forms.select.keyupHandler);
      // this.element.find("select")[0].focus();
    },
    ...
    getValue : function() {
      ...
      var x;
      var return_array = [];
      jQuery.each(this.element.find("input"), function(i, input) {
        var $input = $(input);
        if ($input.is(":checked")) {
          return_array.push(form.sanitizeValue($input.val()));
        }
      });
      return return_array;
    },
